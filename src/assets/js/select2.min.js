...
}),this.selection.bind({el: this, binding: this.$container}),this.dropdown.bind({
  el: this,
  binding: this.$container
}),this.results.bind({
  el: this,
  binding: this.$container
})},d.prototype._registerDomEvents=function(){var t=this;this.$element.on("change.select2",function(){t.dataAdapter.current(function(e){t.trigger("selection:update",{data:e})})}),this.$element.on("focus.select2",function(e){t.trigger("focus",e)}),this._syncA=u.bind({
  el: this._syncAttributes,
  binding: this
}),this._syncS=u.bind({
  el: this._syncSubtree,
  binding: this
